...
const ProductList = () => {
  ...
  const handleSubmit = () => {
    Swal.fire({
      ...
      text: `Your request for ${currentProduct.name} has been sent.`,
        ...
        {products.length === 0 ? (
          ...
          <ul className="space-y-6">
            {products.map((product) => (
              <li key={product._id} className="relative flex flex-col bg-gray-100 p-4 rounded-lg shadow-sm">
        ...
        {currentProduct && (
          <>
            ...
            <form className="space-y-2">
              ...
              <div>
                <p className="block mb-1 font-medium text-gray-700">Select Fabric:</p>
